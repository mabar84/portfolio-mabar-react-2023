...
window.addEventListener("load", function () {
  ...
  // calc sidebar top position 
  if (document.documentElement.clientWidth > 900 && document.querySelector('[data-modal-tlbr]')) {
    const sidebar = document.querySelector('[data-modal-tlbr]');
    const top = window.innerHeight - sidebar.offsetHeight;
    sidebar.style.top = `${top}px`;
  }
  
  // edit SuperJob vacancy html
  for (let vacancy of document.querySelectorAll("#vacancy-informer .informer_row1")) {
    const link = vacancy.querySelector('a');
    const spanText = vacancy.querySelector('br').nextSibling.textContent; 
    ...
    // change vacancy content
    vacancy.innerHTML = "";
    vacancy.appendChild(link);
    vacancy.appendChild(spanElement);
  }
